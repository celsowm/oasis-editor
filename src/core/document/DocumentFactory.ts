...
export const createDocument = () => ({
  ...
  sections: [
    createSection([
      ...
      createParagraph(
        "Documento, composição e paginação agora vivem numa base única, limpa e organizada.",
      ),
      createParagraph(
        "A aplicação mantém identidade única: oasis-editor. Página é parte da arquitetura, não um produto paralelo.",
      ),
      createParagraph(
        "O documento continua contínuo, enquanto o layout paginado é calculado pelo motor de composição.",
      ),
      createParagraph(
        "A próxima camada pode evoluir para edição rica, regras tipográficas e Rust/WASM sem quebrar a separação de responsabilidades.",
      ),
    ]),
  ],
});
