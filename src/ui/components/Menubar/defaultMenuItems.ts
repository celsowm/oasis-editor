...
export const defaultMenuItems: MenuItem[] = [
  ...
  { id: "file_import", path: "File/Import", labelKey: "toolbar.import", shortcut: "Ctrl+O", command: "importDocx", icon: "upload" },
  ...
  { id: "file_export_pdf", path: "File/Export/PDF", command: "exportPdf", icon: "file-down" },
  { id: "file_export_docx", path: "File/Export/DOCX", command: "exportDocx", icon: "file-text" },
  { id: "file_export_html", path: "File/Export/HTML", hidden: true },
  { id: "file_export_md", path: "File/Export/MD", hidden: true },
  { id: "file_print", path: "File/Print", labelKey: "menu.file.print", shortcut: "Ctrl+P", command: "print", icon: "printer" },

  // Edit
  { id: "edit_undo", path: "Edit/Undo", labelKey: "toolbar.undo", shortcut: "Ctrl+Z", command: "undo", icon: "undo-2" },
  { id: "edit_redo", path: "Edit/Redo", labelKey: "toolbar.redo", shortcut: "Ctrl+Y", command: "redo", icon: "redo-2" },
  { id: "edit_cut", path: "Edit/Cut", labelKey: "menu.edit.cut", shortcut: "Ctrl+X", hidden: true },
  { id: "edit_copy", path: "Edit/Copy", labelKey: "menu.edit.copy", shortcut: "Ctrl+C", command: "copy", icon: "copy" },
  { id: "edit_paste", path: "Edit/Paste", labelKey: "menu.edit.paste", shortcut: "Ctrl+V", hidden: true },
  { id: "edit_find", path: "Edit/Find & Replace", labelKey: "find.title", shortcut: "Ctrl+F", command: "find", icon: "search" },
  ...
  { id: "view_margins", path: "View/Show Margins", labelKey: "menu.view.margins", command: "toggleShowMargins", icon: (host) => host.commands.state("toggleShowMargins").isActive ? "check-square" : "square" },
  { id: "view_paragraph_marks", path: "View/Show Paragraph Marks", labelKey: "menu.view.paragraphMarks", command: "toggleShowParagraphMarks", icon: (host) => host.commands.state("toggleShowParagraphMarks").isActive ? "check-square" : "square" },
  ...
  { id: "format_text_bold", path: "Format/Text/Bold", labelKey: "toolbar.bold", shortcut: "Ctrl+B", command: "bold", icon: "bold" },
  { id: "format_text_italic", path: "Format/Text/Italic", labelKey: "toolbar.italic", shortcut: "Ctrl+I", command: "italic", icon: "italic" },
  { id: "format_text_underline", path: "Format/Text/Underline", labelKey: "toolbar.underline", shortcut: "Ctrl+U", command: "underline", icon: "underline" },
  { id: "format_text_strike", path: "Format/Text/Strikethrough", labelKey: "toolbar.strike", command: "strike", icon: "strikethrough" },
  ...
  { id: "format_align_left", path: "Format/Align/Left", labelKey: "toolbar.alignLeft", command: "alignLeft", icon: "align-left" },
  { id: "format_align_center", path: "Format/Align/Center", labelKey: "toolbar.alignCenter", command: "alignCenter", icon: "align-center" },
  { id: "format_align_right", path: "Format/Align/Right", labelKey: "toolbar.alignRight", command: "alignRight", icon: "align-right" },
  { id: "format_align_justify", path: "Format/Align/Justify", labelKey: "toolbar.justify", command: "alignJustify", icon: "align-justify" },
  ...
  { id: "format_lists_bullet", path: "Format/Lists/Bullet List", labelKey: "toolbar.bulletList", command: "bulletList", icon: "list" },
  { id: "format_lists_numbered", path: "Format/Lists/Numbered List", labelKey: "toolbar.numberedList", command: "orderedList", icon: "list-ordered" },
