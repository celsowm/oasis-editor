...
describe("FindReplaceService", () => {
  it("should find simple text matches", () => {
    const doc = createEditorDocument([
      ...
      createEditorParagraph("Another world"),
    ]);
  ...
  it("should handle case-insensitivity by default", () => {
    const doc = createEditorDocument([createEditorParagraph("Hello World")]);
    const matches = findMatchesInDocument(doc, "world");
  ...
  it("should support whole-word matching", () => {
    const doc = createEditorDocument([createEditorParagraph("HelloWorld World")]);
  ...
  it("should escape special regex characters in search term", () => {
    const doc = createEditorDocument([createEditorParagraph("Search for [brackets]?")]);
  ...
  it("should return empty array for empty search term", () => {
    const doc = createEditorDocument([createEditorParagraph("Some text")]);
