...
export async function buildDocx(documentXml: string, numberingXml?: string): Promise<File> {
  const zip = new JSZip();
  zip.file(
    "[Content_Types].xml",
...
export function setupOasisEditorDom(): void {
  document.body.innerHTML = `
    <div id="oasis-editor-root"></div>
    <div id="oasis-editor-loading"></div>
  `;
}
