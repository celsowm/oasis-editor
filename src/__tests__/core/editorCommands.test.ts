...
describe("editor commands", () => {
  ...
  it("inserts text into the current block", () => {
    const state = createEditorStateFromTexts(["hello"], { blockIndex: 0, offset: 2 });
  ...
  it("deletes one character backward inside a block", () => {
    const state = createEditorStateFromTexts(["hello"], { blockIndex: 0, offset: 3 });
  ...
  it("merges with the previous block when backspacing at block start", () => {
    const state = createEditorStateFromTexts(["abc", "def"], { blockIndex: 1, offset: 0 });
    const next = deleteBackward(state);
  ...
  it("moves left and right across block boundaries", () => {
    const start = createEditorStateFromTexts(["ab", "cd"], { blockIndex: 1, offset: 0 });
  ...
  it("moves up and down with clamped offsets", () => {
    const start = createEditorStateFromTexts(["abcd", "xy"], { blockIndex: 0, offset: 3 });
  ...
  it("deletes an expanded cross-block selection with backspace", () => {
    const state = createEditorStateFromTexts(["abc", "def", "ghi"], {
  ...
  it("extends selection left and right from the focus", () => {
    const start = createEditorStateFromTexts(["abcd"], { blockIndex: 0, offset: 2 });
  ...
  it("deletes one character forward inside a block", () => {
    const state = createEditorStateFromTexts(["hello"], { blockIndex: 0, offset: 1 });
  ...
  it("deletes an expanded selection with delete", () => {
    const state = createEditorStateFromTexts(["abc", "def"], {
      anchor: { blockIndex: 0, offset: 1 },
  ...
  it("applies paragraph indentation on a collapsed selection to the focused paragraph", () => {
    const state = createEditorStateFromTexts(["abc", "def"], { blockIndex: 1, offset: 1 });
  ...
  it("removes paragraph spacing when the style value is null", () => {
    const state = createEditorStateFromTexts(["abc"], { blockIndex: 0, offset: 1 });
  ...
  it("clears ordered list when the whole targeted range is already ordered", () => {
    const state = toggleParagraphList(
      createEditorStateFromTexts(["abc", "def"], {
        anchor: { blockIndex: 0, offset: 0 },
        focus: { blockIndex: 1, offset: 1 },
      }),
      "ordered",
  ...
  it("indents a list item by increasing its level", () => {
    const state = toggleParagraphList(
      createEditorStateFromTexts(["abc"], { blockIndex: 0, offset: 0 }),
      "bullet",
    );
  ...
  it("splits a list item and preserves kind and level", () => {
    const state = toggleParagraphList(
      createEditorStateFromTexts(["hello"], { blockIndex: 0, offset: 2 }),
      "ordered",
    );
  ...
  it("preserves table structure when applying text styles", () => {
    const table = createEditorTable([
      createEditorTableRow([
        createEditorTableCell([createEditorParagraph("Cell A")]),
        createEditorTableCell([createEditorParagraph("Cell B")]),
      ]),
    ]);
    const document = createEditorDocument([table]);
    const state = toggleTextStyle(
      createEditorStateFromDocument(document, { paragraphIndex: 0, offset: 2 }),
      "bold"
    );
  ...
  it("preserves table structure when moving selection left and right", () => {
    ...
    const state = createEditorStateFromDocument(createEditorDocument([table]), { paragraphIndex: 1, offset: 0 });
  ...
  // â”€â”€ insertImageAtSelection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  it("inserts an image at the beginning of an empty paragraph", () => {
    const state = createEditorStateFromTexts([""], { blockIndex: 0, offset: 0 });
  ...
  it("replaces a selection with an image run", () => {
    const state = createEditorStateFromTexts(["abc"], {
      anchor: { blockIndex: 0, offset: 0 },
      focus: { blockIndex: 0, offset: 3 },
    });
  ...
  it("moves a selected image to another paragraph position", () => {
    const source = createEditorStateFromTexts(["a", "b"], { blockIndex: 0, offset: 1 });
  ...
  it("moves a selected image to the previous paragraph position", () => {
    const source = createEditorStateFromTexts(["a", ""], { blockIndex: 1, offset: 0 });
    const withImage = insertImageAtSelection(source, {
      src: "data:image/png;base64,abc",
      width: 100,
      height: 50,
  ...
  // â”€â”€ insertTableAtSelection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  it("inserts a table with correct dimensions after the current paragraph", () => {
    const state = createEditorStateFromTexts(["before", "after"], { blockIndex: 0, offset: 3 });
  ...
  it("moves the caret into the first cell after table insertion", () => {
    const state = createEditorStateFromTexts(["hello"], { blockIndex: 0, offset: 5 });
  ...
  it("each table cell starts with an empty paragraph", () => {
    const state = createEditorStateFromTexts(["x"], { blockIndex: 0, offset: 0 });
  ...
  it("does not collapse surrounding paragraphs when inserting table", () => {
    const state = createEditorStateFromTexts(["A", "B", "C"], { blockIndex: 1, offset: 0 });
