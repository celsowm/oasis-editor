...
- Name: editor.spec.ts >> Oasis Editor Behavioral Tests >> should handle formatting commands
- Location: e2e\editor.spec.ts:70:3
...
Call log:
  - waiting for locator('#oasis-editor-loading') to be detached
    61 × locator resolved to visible <div id="oasis-editor-loading">…</div>
