...
const allowlistedFiles = new Map([
  ...
  ["src/ui/components/Toolbar/LineSpacingButton.tsx", "pending toolbar migration"],
  ["src/ui/components/Toolbar/controls/UnderlineControl.tsx", "pending toolbar migration"],
  ["src/ui/components/Toolbar/controls/ListOptionsControl.tsx", "pending toolbar migration"],
  ["src/ui/components/Toolbar/groups/MarginsGroup.tsx", "pending toolbar migration"],
  ["src/ui/components/FloatingToolbar/FloatingLayoutOptions.tsx", "pending floating toolbar migration"],
  ["src/ui/components/PluginUi/PluginUiHost.tsx", "pending plugin host polish"],
  ["src/ui/components/Dialogs/Dialog.tsx", "public dialog primitive implementation"],
  ["src/ui/components/Dialogs/font-dialog/FontTab.tsx", "pending font tab migration"],
  ["src/ui/components/Dialogs/ParagraphDialog.tsx", "pending paragraph dialog migration"],
  ["src/ui/components/Dialogs/LineSpacingDialog.tsx", "pending dialog migration"],
  ["src/ui/components/Dialogs/table-properties/TableTabPanel.tsx", "pending table tab migration"],
  ["src/ui/components/Dialogs/table-properties/RowTabPanel.tsx", "pending table tab migration"],
  ["src/ui/components/Dialogs/table-properties/ColumnTabPanel.tsx", "pending table tab migration"],
  ...
  ["src/ui/components/Toolbar/ribbon/RibbonGroup.tsx", "toolbar shell structure"],
  ["src/ui/components/Toolbar/ribbon/RibbonTabs.tsx", "toolbar shell structure"],
  ["src/ui/components/Toolbar/ToolbarOverflowManager.tsx", "pending toolbar migration"],
  ...
  ["src/ui/components/CommentHighlightOverlay.tsx", "pending overlay migration"],
